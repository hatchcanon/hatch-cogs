# some shit I'm using as an example. This is was written for 0.16 discord.py so no longer current
import os
import random
import sys
...
def get_context_vc(ctx: commands.Context) -> discord.VoiceChannel.name:
    u"""発言者がいるVCを取得する
    ...
    server = ctx.message.server  # type: discord.Guild.name
    all_vc = ctx.guild.voice_channels
